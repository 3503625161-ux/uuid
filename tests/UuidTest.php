...
class UuidTest extends TestCase
{
    ...
    public function testFromGuidString(): void
    {
        ...
        Uuid::setFactory(new UuidFactory(FeatureSetBuilder::fromDefaults(true)->build()));
    ...
    {
        Uuid::setFactory(new UuidFactory(FeatureSetBuilder::fromDefaults(false, false, false, true)->build()));
    ...
    public function test32BitMatch64BitForOneHourPeriod(): void
    {
        ...
        $smallIntFeatureSet = FeatureSetBuilder::fromDefaults(false, true)
            ->withTimeProvider($timeOfDay)
            ->build();
    ...
    {
        $uuidFactory = new UuidFactory(FeatureSetBuilder::fromDefaults(false)->build());
        $guidFactory = new UuidFactory(FeatureSetBuilder::fromDefaults(true)->build());
